$(document).ready(function () {
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyCJpqAtD836FP01hndM54OLqQMLjVYRcLY",
    authDomain: "prueba-c15ea.firebaseapp.com",
    projectId: "prueba-c15ea",
    storageBucket: "prueba-c15ea.appspot.com",
    messagingSenderId: "1007161956856",
    appId: "1:1007161956856:web:9f22c8d36c50cb5dc81e0d",
    measurementId: "G-EXQ7VYWLSL"
  };
  ...
  function postList(data) {
    ...
    if (data.length > 0) {
      ...
      data.forEach(doc => {
        const post = doc.data();
        const div = `
          <div class="card bg-primary text-white  mt-3 mx-auto" style="border-radius: 1rem; width: 800px;">
            <div class="card-body">
              <p>${post.mensaje}</p>
              <p>Publicado el ${post.fecha} a las ${post.hora}</p>
              <button data-id="${doc.id}" class="btn btn-warning btn-edit-post bi bi-pencil-fill">
                Editar
              </button>
